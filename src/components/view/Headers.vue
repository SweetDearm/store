<template>
  <div class="headers">
    ...
    <div class="headerlog">
        ...
        <ul class="resout">
          <li class="item" @click="to"
           v-for="(target, index) in getResoutItem" :key="index" 
          >
           {{ target.title }} </li>
        </ul>
        </div>
   ...
   <div class="headernav">
     <div class="sales">
       ...
       <i class="el-icon-s-grid"></i>
        ...
        <div class="sales-ul" @mouseenter="onMouseOver" @mouseleave="onMouseout">
          <ul v-show="ishow">
            <li>
              <div>
...
export default {
   ...
   components:{
    ...
    computed: {
     ...
     watch:{
       nowInput(){
         if(this.nowInput){
           console.log(this.getResoutItem)
           return this.getResoutItem 
         }
       }
     },
     mounted() {
  ...
  methods: { 
    ...
    to(e){  
      //var url=encodeURI(encodeURI(this.nowInput));
