 ...
 <div class="ring">
  ...
  <div class="ringn">
    ...
    <div class="ringnav">
      ...
      <div class="ringclass">
        ...
        <ul>
          ...
          <li><a href="javascript:;">精品戒指</a></li>
          <li><a href="javascript:;">对戒</a></li>
        </ul>
      </div>
      <div class="ringclass">
        <div class="title-">规格：</div>
         <ul>
          <li><a href="javascript:;">全部</a></li>
          <li><a href="javascript:;">国际7号</a></li>
          <li><a href="javascript:;">国际8号</a></li>
          <li><a href="javascript:;">国际9号</a></li>
    ...
    <div class="product-ring">
      <div class="pr" v-for="(item,i) of list1" :key=i>
       <div class="img">
...
export default {
  data (){
    return {
      ...
      list1:[
        // {PlaceImgUrl:'https://aimg8.dlssyht.cn/u/1872058/product/6252/12502036_1556593896.jpg',Price:"8880",title:'楼兰客栈菩提子天珠配饰挂件复古民族'},
        //  {PlaceImgUrl:'https://aimg8.dlssyht.cn/u/1872058/product/6252/12502036_1556593896.jpg',Price:"8880",title:'楼兰客栈菩提子天珠配饰挂件复古民族'},
        //    {PlaceImgUrl:'https://aimg8.dlssyht.cn/u/1872058/product/6252/12502036_1556593896.jpg',Price:"8880",title:'楼兰客栈菩提子天珠配饰挂件复古民族'},
        //  {PlaceImgUrl:'https://aimg8.dlssyht.cn/u/1872058/product/6252/12502036_1556593896.jpg',Price:"8880",title:'楼兰客栈菩提子天珠配饰挂件复古民族'},
        //     {PlaceImgUrl:'https://aimg8.dlssyht.cn/u/1872058/product/6252/12502036_1556593896.jpg',Price:"8880",title:'楼兰客栈菩提子天珠配饰挂件复古民族'},
  ...
  methods: {
    pagenext(){//下一页
      ...
      this.axios.get(url,{params:obj}).then(result=>{
        this.list1=[];
        for (const item of result.data.list1) {
